 ...
 *
 * ENC-TSK-P92 (ports ENC-TSK-P80 AC-2/AC-3). Same base path and cookie-auth
 * transport as api/documents.ts / api/documentManifest.ts.
 */
...
export async function patchSection(
  ...
  const url = `${API_BASE}/documents/${encodeURIComponent(documentId)}/sections`

import type { Task, Issue, Feature, Lesson, Plan, ProjectsFeed, TasksFeed, IssuesFeed, FeaturesFeed, LessonsFeed, PlansFeed, DocumentsFeed } from '../types/feeds'
...
export const feedKeys = {
  ...
  lessons: ['feed', 'lessons'] as const,
  plans: ['feed', 'plans'] as const,
...
export const fetchLessons = () => fetchFeed<LessonsFeed>('lessons')
export const fetchPlans = () => fetchFeed<PlansFeed>('plans')

...
const TerminalManagePage = lazy(() =>
  import('../pages/TerminalManagePage').then((module) => ({ default: module.TerminalManagePage })),
)
const ComponentRegistryPage = lazy(() =>
  import('../pages/ComponentRegistryPage').then((module) => ({
